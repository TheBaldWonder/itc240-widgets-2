...
$config->nav1['contact-compound.php'] = "COMPOUND CONTACT";
$config->nav1['shoe_list.php'] = "SHOE LIST";
$config->nav1['shoes.php'] = "SHOES";
...
$sub_folder = 'itc240/widgets2/';//change to 'widgets' or 'sprockets' etc.
...
switch(THIS_PAGE){  
    ...
    break;
     case 'contact-compound.php':
        $config->title = 'Compound Contact Page';
    break;
         case 'shoe_list.php':
        $config->title = 'Shoe List';
    break;
         case 'shoes.php':
        $config->title = 'Shoes';
    break;
